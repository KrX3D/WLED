...
#endif
#ifndef WIFI_DEFAULT_AP_CHANNEL_SAVE_RAM
  #define WIFI_DEFAULT_AP_CHANNEL_SAVE_RAM 1
#endif
...
typedef class WiFiOptions {
  ...
  #ifdef ARDUINO_ARCH_ESP32
WLED_GLOBAL wifi_options_t wifiOpt _INIT_N(({0, WIFI_DEFAULT_AP_CHANNEL_SAVE_RAM, WIFI_DEFAULT_AP_HIDE, WIFI_DEFAULT_AP_BEHAVIOR, WIFI_DEFAULT_NO_WIFI_SLEEP, WIFI_DEFAULT_FORCE_802_3G}));
  #else
WLED_GLOBAL wifi_options_t wifiOpt _INIT_N(({0, WIFI_DEFAULT_AP_CHANNEL_SAVE_RAM, WIFI_DEFAULT_AP_HIDE, WIFI_DEFAULT_AP_BEHAVIOR, WIFI_DEFAULT_NO_WIFI_SLEEP, WIFI_DEFAULT_FORCE_802_3G}));
  #endif
...
#endif
#if defined(IR_DEFAULT_APPLY_TO_MAIN_SEGMENT_ONLY) && !defined(IR_DEFAULT_APPLY_TO_ALL_SELECTED)
  #define IR_DEFAULT_APPLY_TO_ALL_SELECTED (!IR_DEFAULT_APPLY_TO_MAIN_SEGMENT_ONLY)
#endif
#ifndef IR_DEFAULT_APPLY_TO_ALL_SELECTED
  #define IR_DEFAULT_APPLY_TO_ALL_SELECTED true
#endif
WLED_GLOBAL bool irApplyToAllSelected _INIT(IR_DEFAULT_APPLY_TO_ALL_SELECTED); //apply IR or ESP-NOW to all selected segments
